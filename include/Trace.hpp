 ...
 */
class Trace : public std::vector<int> // in the structure of std::vector<int> by YX
{
 private:
 ...
 public:
  ...
  double GetValue(std::string name) const {
    ...
    void Plot(int id, int row);  //< plot trace into row of a 2D histogram; used in plotting 7500, by YX
