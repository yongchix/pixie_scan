...
static double cnnt = 0;
static double yichu = 0;
...
bool NaIProcessor::Process(RawEvent &event)
{
  ...
  if(vecTime.at(vecTime.size() - 1) - vecTime.at(0) > Globals::get()->eventWidth()){
    yichu++;
    cout << "\n Yichu: (" << yichu <<"/"  << cnnt << ") = " << yichu/cnnt*100 << " " 
	 << vecTime.at(vecTime.size() - 1) - vecTime.at(0) << " Event Width: " << Globals::get()->eventWidth() << endl;
  }
