...
namespace dammIds { 
  namespace dssd4jaea {
    ...
    //---------------------- by Yonghi Xiao; 04/12/2015; 04/28/2015; 05/11/2015; 05/25/2015 06/10/2015; 07/06/2015 ---
    const int DD_CORRELATION_MATRIX_100F = 7;
    const int DD_CORRELATION_MATRIX_100B = 8;
    const int D_LOGDECAYTIME_0 = 9;

    const int D_PLUGIN_NAI_SUM = 10;
    const int DD_DSSD1_VS_NAI = 11; 
    const int DD_DSSD2_VS_NAI = 12;
    const int D_INTVL_DSSD_NAI = 15;
    const int DD_INTVL_DSSD = 16;
    const int DD_INTVL_NAI = 17;
    //---------------------------------------------------------------
