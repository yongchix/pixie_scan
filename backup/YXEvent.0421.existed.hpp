...
public: 
  ...
  int GetCorrLength() {return corrEvents.size();} // by Yongchi Xiao; 02/02/2016
  ...
  int GetIndivChannel(int i){ return corrEvents.at(i).GetChannel();} // by Yongchi Xiao; 11/13/2015
