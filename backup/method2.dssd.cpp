...
bool Dssd4JAEAProcessor::Process(RawEvent &event)
{
	...
	if( //xEnergy < 2730 && yEnergy < 2730
	    ...
	    )          
	  {
		  ...
		  )
		{
		  ...
		  //if( (energy1F - 800)*(energy1F - 940)< 0
		  //  && (xEnergy - 920)*(xEnergy - 1040) < 0
		  //  )
		    {
		      ...
		      plot(D_LOGDECAYTIME_0, (time - chain[1][x][y].time)*pow(10, -5)); // 709
		    }
  ...
  //   vecNaiEvents.erase(vecNaiEvents.begin(), vecNaiEvents.begin() + vecNaiEvents.size()); // by Yongchi Xiao; 06/16/2015
